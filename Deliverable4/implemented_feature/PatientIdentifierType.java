...
public class PatientIdentifierType extends BaseChangeableOpenmrsMetadata {
	...
	/**
	 * the function checks the similarity of the current IdentifierType and the given IdentifierType
	 * if two consider the same then the function return true, otherwise return false
	 * @param patientIdentifier
	 * @return the IdentifierType is equal to the given one
	 */
	public boolean equalIdentifierType(PatientIdentifierType patientIdentifier){
		...
		// if the formatDescription is same, then two PatientIdentifierTypes are same
		    ...
		    if (this.formatDescription == patientIdentifier.getFormatDescription()) {
		        return true;
		    }
		}
