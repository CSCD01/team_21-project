...
public class HibernatePatientDAOTest extends BaseContextSensitiveTest {
	...
	public void testDatabase1() {
		...
		Assert.assertEquals(2, hibernatePatientDao.getAllPatientIdentifierTypes(true).size());
	}
	...
	public void testUser2() {
		...
		Assert.assertEquals(1, hibernatePatientDao.getAllPatientIdentifierTypes(true).size());
	}
